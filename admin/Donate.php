    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Select your Donation and Donate what Amount You want</h3>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form action="ins.php" method="POST">
                                        ...
                                        <label for="exampleInputpwd2">Select Donation from list</label>
                                        </div> 
                                        <?php 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="enterAmount" name="enterAmount" class="form-control" placeholder="Enter Amount" aria-label="Amount"> </div>
                                        </div>
