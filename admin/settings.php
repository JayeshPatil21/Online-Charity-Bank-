...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form action="functions/settings.php" method="post">
                                      ...
                                      <!--   <div class="form-group">
                                            <label for="exampleInputuser1">user address</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="ti-user"></i></div>
                                                <input type="user" name="user" class="form-control" id="exampleInputuser1" placeholder="Enter user" required=""> </div>
                                        </div> -->
            ...
            <!-- /.container-fluid -->
            <footer class="footer text-center">&copy; Cahrity Bank Panel </footer>
        </div>
        <!-- /#page-wrapper -->
    </div>
    <!-- /#wrapper -->
