...
<head>
    ...
    <title>Charity Bank Users</title>
    <!-- Bootstrap Core CSS -->
...
<body>
    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li> <a href="#" class="waves-effect"><i data-icon="&#xe00b;" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Donation Setting<span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
                            ...
                            <li><a href="comments.php" class="waves-effect">Update And Delete</a>
                            </li>
                        </ul>
                    </li>
                   <!-- User Setting -->
        ...
        <div id="page-wrapper">
                ...
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12"> 
                        <ol class="breadcrumb">
                            ...
                            <li class="active"> <a href="new-user.php" class="btn btn-success btn-rounded btn-outline hidden-xs hidden-sm waves-effect waves-light">Delete Donation Name </a></li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <h3 class="box-title m-b-0">Charity Bank Administrators ( <x style="color: orange;"><?php echo mysqli_num_rows($query);?></x> )</h3>
                                ...
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    ...
                                    echo '
                                        ...
                                        <tr>
                                            ...
                                            <!-- /.delete Butoon Code -->   
                                            <td><a href="#"><i class="fa fa-trash"  data-toggle="modal" data-target="#responsive-modal'.$row["SID"].'" title="remove" style="color:red;"></i></a></td>
                                       

                                            <!-- /.modal -->
                                            <div id="responsive-modal'.$row["SID"].'" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                            <h4 class="modal-title">Are you sure you want to delete this Donation from List  '.$row["DName"].' ?</h4></div>
                                            ...
                                            <!-- End Modal -->
                                            <!-- /.End delete Butoon Code -->
                                            
                                            

                                            <!-- /.Edit Butoon Code -->   
                                            <td><a href="#"><i class="fa fa-edit"  data-toggle="modal" data-target="#responsive-modaledit'.$row["SID"].'" title="remove" style="color:green;"></i></a></td>
                                       

                                            <!-- /.modal -->
                                            <div id="responsive-modaledit'.$row["SID"].'" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                            <h4 class="modal-title">Are you sure you want to Edit this Record  '.$row["DName"].' ?</h4></div>
                                                        <div class="modal-footer">
                                                        <form action="Donationedit.php" method="post">
                                                        <input type="hidden" name="SID" value="'.$row["SID"].'"/>
                                                            <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Close</button>
            ...
            <!-- /.container-fluid -->
            <footer class="footer text-center"> &copy; Charity Bank Panel</footer>
        </div>
        <!-- /#page-wrapper -->
    </div>
    <!-- /#wrapper -->
