...
<?php
    ...
    if ($AT=="Admin")
    {
        $sql = "SELECT * FROM donateamt";
        $query = mysqli_query($conn, $sql);
    }
    else{
        
        $sql = "SELECT * FROM donateamt where user='$user' ";
        $query = mysqli_query($conn, $sql);
    }
...
<head>
    ...
    <title>Charity Bank Histroy </title>
    <!-- Bootstrap Core CSS -->
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12"> 
                        <ol class="breadcrumb">
                            ...
                            <li><a href="#">User Donation Histroy</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Charity Bank User Donation History</h3>
                            ...
                            <div class="table-responsive">
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    ...
                                    if (mysqli_num_rows($query)==0) {
                                                    echo "<i style='color:brown;'>No Donation History yet:( </i> ";
                                                }
                                                else{
