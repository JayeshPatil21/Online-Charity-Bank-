                            ...
                            <div class="col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="DName" name="DName" class="form-control" placeholder="Enter Donation Name" aria-label="Donation Name"> </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputpwd1">Email ID</label>
                                        <div class="input-group">
                                            <div class="input-group-addon"><i class="ti-bookmark-alt"></i></div>
                                            <input type="text" id="EID" name="EID" class="form-control" placeholder="Enter Email Id Of Donation" aria-label="EID"> </div>
                                    </div>
