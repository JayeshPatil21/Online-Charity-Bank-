...
<head>
    ...
    <title>Charity Bank All Donations List </title>
    <!-- Bootstrap Core CSS -->
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12"> 
                        <ol class="breadcrumb">
                            ...
                            <li><a href="#">All Donations List</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Charity Bank User Donation List</h3>
