...
if (isset($_POST["SID"])) {
    ...
    $SID=$_POST["SID"];
    $_SESSION['SID']=$SID;
    $sql_SDREG = "SELECT * FROM donationreg  WHERE SID=$SID";
    //echo $sql_SDREG;
    $query_SDREG = mysqli_query($conn, $sql_SDREG);
    $row = mysqli_fetch_assoc($query_SDREG);
     $Name=$row['DName'];
     $EID=$row['EID'];
...
<title>Charity Bank Donation</title>
<!-- Bootstrap Core CSS -->
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="col-md-12">
                <div class="white-box">
                    <h3 class="box-title m-b-0">ENTER THE DONATION NAME AND EMAILID </h3>
                    
                    <div class="row">
                        <div class="col-sm-12 col-xs-12">
                            <form action="functions/UP_post.php" method="POST">
                          
                            <div class="form-group">
                                    <label for="exampleInputpwd1">Donation Name</label>
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="ti-user"></i></div>
                                        <input type="text" id="DName" name="DName" class="form-control" placeholder="Enter Donation Name" aria-label="Donation Name" value="<?php echo $Name?>"> </div>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputpwd1">Email ID</label>
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="ti-bookmark-alt"></i></div>
                                        <input type="text" id="EID" name="EID" class="form-control" placeholder="Enter Email Id Of Donation" aria-label="EID" value="<?php echo $EID?>"> </div>
                                </div>
                                <button type="submit" name="savedata" class="btn btn-success waves-effect waves-light m-r-10">Submit</button>
                            </form>
                        </div>
                    </div>
                </div>
